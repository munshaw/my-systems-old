...
## Some Tweaks
To freshen up the desktop from time to time, I use the [PlingStore](https://www.pling.com/). I'm currently using the Orchis theme. Enable webrender and use-argb-visuals in Firefox in `about:config`.
